      ...
      <div class="panel panel-default">
        ...
        <div class="panel-body">
          <table class="table table-bordered">
            <thead>
              <tr>
                <th class="text-center" style="width: 50px;">Seq</th>
                <th> Nome do processo </th>
                <th class="text-center" style="width: 10%;"> Tipo de processo </th>
                <th class="text-center" style="width: 10%;"> Horário de carga </th>
                <th class="text-center" style="width: 10%;"> Data do últ. exec. </th>
